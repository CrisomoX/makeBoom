...
local function RetriveGameDetails()
	...
	local GameDetails = (function() local s, res = pcall(function() return Marketplace:GetProductInfo(game.PlaceId) end) if not s then return {Name="? - Failed to load"} else return res end)();
	return {
